...
export default function Digital() {
  return (
    <section className="bg-gradient-to-r from-[#0E1622] to-[#0B111A] w-ful text-white">
      <div className="max-w-7xl mx-auto">
        ...
        <div className="flex flex-col sm:flex-row items-stretch bg-gradient-to-r from-[#0E1622] to-[#0B111A]">
          ...
          <div className="text-center sm:text-left w-full sm:w-1/2 order-1 sm:order-2 sm:mt-0 px-5 sm:px-10 py-5  sm:py-1 md:py-0 lg:px-15">
            <h2 className="text-[30px] sm:text-[20px] md:text-[23px] lg:text-[30px] xl:text-[45px] font-bold">Path to Digital</h2>
            <p className="text-[30px] sm:text-[20px] md:text-[23px] lg:text-[30px] xl:text-[45px]">Excellence</p>

            <p className="text-gray-300 mt-1 text-[14px] sm:text-[7px] md:text-[9px] lg:text-[12px] xl:text-[16px] text-center sm:text-left">
              At ISCE, we believe that technology should empower,
inspire, and transform. We're not just building products;
we're crafting experiences that bridge the gap between
innovation and impact.
            ...
            <div className=" mt-2  grid grid-cols-2 grid-rows-2 gap-4 sm:gap-2 items-center">
              {statsData.map((item) => (
                <div key={item.id} className="flex flex-col items-center justify-center sm:items-start sm:justify-start">
                  {/* Circle */}
                  ...
                  {/* Label */}
                  <p className="text-sm  sm:text-[7px] md:text-[9px] md:text-[11
