        ...
        <div className="grid items-center relative sm:grid-cols-2 gap-14 ">
          ...
          <div className="z-20">
            ...
            <div className="flex-wrap gap-5 sm:flex sm:flex-row">
              <button className="mt-6 cursor-pointer bg-linear-to-r from-[#0086FF] to-[#B0D9FF]  rounded flex items-center gap-1 px-2 h-10 md:px-3 sm:h-6 md:h-8 sm:text-[8px] md:text-[10px] lg:text-[12px]">
                Free Consultation <LeftIcon className="w-2 h-2" />
              </button>

              <button className="mt-6 cursor-pointer bg-linear-to-r from-[#0086FF] to-[#B0D9FF]  rounded text-sm flex items-center gap-2 px-2  md:px-3 h-10 sm:h-6 md:h-8 sm:text-[8px] md:text-[10px] lg:text-[12px]">
                <img
