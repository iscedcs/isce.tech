...
export default function LuxurySection() {
  return (
    <section className="bg-[#0E1622] text-white py-20 px-[8%] overflow-hidden">
      <MaxWidthWrapper>
        <div className="text-center">
          {/* Badge */}
          <div className="inline-block px-4 py-1 rounded-full border-2 border-[#404040] text-xs lg:text-[15px] mb-6">
            <h1 className="bg-linear-to-r from-[#231942] to-[#7F3FBF] via-[#3842D1] bg-clip-text text-transparent">
              THE FUTURE IS NOW
            </h1>
          </div>
          {/* Heading */}
          <h2 className="text-4xl font-semibold leading-tight text-[#8C8C8C]">
            Redefining Luxury
            <br />
            <span className="text-[#0086FF] text-[30px] font-semibold">
              with Tech
            </span>
          </h2>
          ...
          {/* Paragraph */}
          <p className="max-w-2xl mx-auto mt-6 text-[#8C8C8C] text-sm text-center  leading-relaxed ">
            Enter a contactless world where technology enhances every
            interaction. From NFC-
            <br /> powered experiences to smart automation, we're building the
            infrastructure for
            <br /> tomorrow’s connected lifestyle.
          </p>
          ...
          <div className="grid sm:grid-cols-3 gap-[5%] mt-[8%]">
            ...
            <div className="bg-[#161B35] text-left p-3 sm:p-4 lg:p-5 rounded-xl border border-[#2D3248] min-w-0">
              ...
              />
              <h4 className="font-semibold text-lg sm:text-[12px] md:text-[14px] lg:text-[14px] xl:text-[16px] 2xl:text-[18px] mb-2">
                Smart Living
              </h4>
              <p className="text-gray-400 text-[14px] sm:text-[6px] md:text-[8px] lg:text-[11px] xl:text-[14px] 2xl:text-[20px]">
                Transform your lifestyle with intelligent automation and
                connected devices.
              </p>
            </div>
            ...
            <div className="bg-[#161B35] text-left p-3 sm:p-4 lg:p-5 rounded-xl border border-[#2D3248] min-w-0">
              ...
              />
              <h4 className="font-semibold text-lg sm:text-[12px] lg:text-[14px] xl:text-[16px] 2xl:text-[18px] mb-2">
                Contactless Tech
              </h4>
              <p className="text-gray-400 text-[14px] sm:text-[6px] md:text-[8px] lg:text-[11px] xl:text-[14px] 2xl:text-[20px]">
