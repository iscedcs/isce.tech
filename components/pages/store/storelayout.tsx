...
import { ExternalLink, Menu, ShoppingCart, X } from "lucide-react";
    ...
    <div>
      <header className="w-full font-sans">
        ...
        <div className="md:hidden w-full bg-white flex justify-between items-center px-4 py-2 text-black text-sm font-medium">
          ...
          <nav className="w-full bg-[#0D0D0F] text-white py-3 px-4 md:px-10 shadow-md">
      <div className="max-w-7xl mx-auto flex items-center justify-between">
        ...
        <div className="flex items-center gap-6 text-sm">
          ...
          <button className="flex items-center gap-2 hover:opacity-80 transition">
            <img src="/images/home.svg" alt="Back" width={12} height={12} />
        ...
        <div className="flex items-center gap-3 text-sm">
          ...
          <div className="w-8 h-8 rounded-full bg-gradient-to-br from-purple-500 to-indigo-600 flex items-center justify-center text-white font-medium">
            <span><img src="/images/user.svg" className="h-4 w-4"/></span>
          </div>
